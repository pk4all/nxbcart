...
function EditPage(){
    ...
    const {attribute} = usePage<{ attribute: Attribute}>().props;
    ...
    function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
      ...
      function handleChange(
        ...
        if((name=='type' && value!='checkbox') && (name=='type' && value!='radio')){
                      ...
                      <div className="card">
                          <div className="card-body">
                              <div className="title-header option-title">
                                  ...
                                  <Link href="/admin/attributs" className="align-items-center btn btn-theme">
...
EditPage.layout = (page: React.ReactNode) => (
  <AdminLayout title="Add Attributs" children={page} />
);
