...
function EditPage(){
    const { invalidError,shipping } = usePage<any>().props;
    ...
    const {
      ...
      defaultValues: {
        min_cart_amount:shipping?.min_cart_amount,
        max_cart_amount:shipping?.max_cart_amount,
        shipping_cost:shipping?.shipping_cost
      },
    });
    const onSubmit = async (data: any) => {
      setBtnLoading(true);
      Inertia.post('/admin/shippings/update/'+shipping?.id,data,
        {
            preserveScroll: true,
            headers: {
  ...
  return (
    <>
    <Head title="Add Shipping Information" />
                      ...
                      <div className="card">
                          <div className="card-body">
                              <div className="title-header option-title">
                                  ...
                                  <Link href="/admin/shipping" className="align-items-center btn btn-theme">
...
EditPage.layout = (page: React.ReactNode) => (
  <AdminLayout title="Edit Tax" children={page} />
);
